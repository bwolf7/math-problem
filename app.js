...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let resultsum =  a + " and " + b + " and " + c + " sum to " + totalsum + ".";
  let resultmult =  "The product of " + a + " and " + b + " and " + c + " is " + totalmult + ".";
  return [totalsum, totalmult, resultsum, resultmult];
...
function sumArray(sumArr) { //eslint-disable-line
  let total = sumArr[0]
  let elements =sumArr[0]
  for (let i = 1; sumArr.length > i; i++){
    total = sum(total, sumArr[i])[0]
    elements += "," + sumArr[i]
  }
  let result = elements + " was passed in as an array of numbers, and " + total + " is their sum."
  return [total, result];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  let total = multArr[0]
  let elements =multArr[0]
  for (let i = 1; multArr.length > i; i++){
    total = multiply(total, multArr[i])[0]
    elements += "," + multArr[i]
  }
  let result = "The numbers " +elements + " have a product of " + total + "."
  return [total, result];
}
...
is the product of those numbers, and the second element is a string that EXACTLY follows this example and concatenates a message using the arguments that were passed into the function:
